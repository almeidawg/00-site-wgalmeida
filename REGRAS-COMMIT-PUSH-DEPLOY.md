...
## 7. WG/Build.tech clientes no monodomain

- Nome publico oficial: `WG/Build.tech`.
- `WG_Build.tech` e nomenclatura legada e nao deve ser publicada novamente.
...
- Checklist minimo para clientes WG/Build.tech:
