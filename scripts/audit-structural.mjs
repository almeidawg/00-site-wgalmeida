...
const companyPublic = read('src/data/companyPublic.js')
assertIncludes(companyPublic, 'https://wgalmeida.com.br', 'SSoT site')
assertIncludes(companyPublic, 'https://easy.wgalmeida.com.br', 'SSoT WGEasy')
assertIncludes(companyPublic, 'https://obraeasy.wgalmeida.com.br', 'SSoT ObraEasy')
assertIncludes(companyPublic, 'https://easyrealstate.wgalmeida.com.br', 'SSoT EasyRealState')
assertNotIncludes(companyPublic, 'app.obraeasy.com.br', 'SSoT dominio legado')
